...
L["settings.hud_game.centerhint_reload_percent.desc"] = "Muestra un aviso de recarga cuando el cargador actual está en este valor porcentual."
L["settings.hud_game.centerhint_bipod.title"] = "Mostrar Alternar Bípode"
L["settings.hud_game.centerhint_bipod.desc"] = "Mostrar un aviso cuando el bípode se puede conmutar."
...
L["settings.developer.dev_show_affectors.desc"] = "Muestra los afectores que se están aplicando actualmente.\n\nRequiere \"Punto de Mira Dev\"."
