...
////////// ARC9 HUD
L["v2.settings.server.hud_game.hud_arc9.title"] = "Stäng Globalt Av ARC9-Gränssnittet"
L["v2.settings.server.hud_game.hud_arc9.desc"] = "Stänger av förmågan att användare kan använda ARC9-gränssnittet."

////////// Visuals
L["v2.settings.server.gameplay.truenames.title"] = "Aktivera Verkliga Namn"
L["v2.settings.server.gameplay.truenames.desc"] = "Aktivera för att få vapen som använder fiktiva namn att visa deras verkliga namn istället.\n\nInte alla vapen stödjer detta."

////////// Gameplay
L["v2.settings.server.aimassist.enable.title"] = "Tillåt Siktehjälp"
L["v2.settings.server.aimassist.enable.desc"] = "Tillåter att användare kan använda siktehjälp."

L["v2.settings.server.aimassist.intensity.title"] = "Siktehjälp Styrka"
L["v2.settings.server.aimassist.intensity.desc"] = "Hur intensiv siktehjälpen borde vara."

L["v2.settings.server.aimassist.cone.title"] = "Siktehjälp Kon"
L["v2.settings.server.aimassist.cone.desc"] = "Hur stort område siktehjälpen tillämpas i. Ju större den är ju längre bort kan giltiga måltavlor vara."

L["v2.settings.server.aimassist.heads.title"] = "Sikte mot Huvuden"
L["v2.settings.server.aimassist.heads.desc"] = "Aktivera om siktehjälpen borde sikta in mot målets huvud istället för bröstkorgen."

L["v2.settings.server.gameplay.infinite_ammo.title"] = "Aktivera Oändlig Ammo"
L["v2.settings.server.gameplay.infinite_ammo.desc"] = "Vapen kräver inte längre ammunition när dem laddas om."

L["v2.settings.server.gameplay.realrecoil.title"] = "Aktivera Fysiskt Visuell Rekyl"
L["v2.settings.server.gameplay.realrecoil.desc"] = "Diverse vapen har tillgång till fysisk mynningstigning, vilket betyder att dem skjuter där deras vymodell pekar istället på skärmens center.\n\nVäldigt viktigt för vissa vapenpakets balansering."

L["v2.settings.server.gameplay.lean.title"] = "Tillåt Lutning"
L["v2.settings.server.gameplay.lean.desc"] = "Tillåter användare att luta sig vänster och höger. Gäller också för Automatisk Lutning."

L["v2.settings.server.gameplay.mod_sway.title"] = "Aktivera Vapensvängning"
L["v2.settings.server.gameplay.mod_sway.desc"] = "Aktivera vapensvängning om vapen stödjer det.\n\nVapen kommer röra sig vilket gör att vymodellen och hårkorset förflyttar sig bort från skärmens center."

L["v2.settings.server.gameplay.mod_freeaim.title"] = "Aktivera Fri Vy"
L["v2.settings.server.gameplay.mod_freeaim.desc"] = "Aktiverar fri vy om vapnet stödjer det.\n\nTillåter siktepunkten att vara separat från skärmens center."

L["v2.settings.server.gameplay.mod_bodydamagecancel.title"] = "Kroppskada Avbrytning"
L["v2.settings.server.gameplay.mod_bodydamagecancel.desc"] = "Stänger av standard kroppskada multiplikatorn.\n\nStäng endast av om ett annat tillägg erbjuder denna funktion."

L["v2.settings.server.gameplay.breath_slowmo.title"] = "Andning i Slow-Mo i Enspelareläge"
L["v2.settings.server.gameplay.breath_slowmo.desc"] = "! Endast Enspelareläge !\nTiden saktar ner när du håller andan."

L["v2.settings.server.gameplay.manualbolt.title"] = "Kräv Manuell Repetering"
L["v2.settings.server.gameplay.manualbolt.desc"] = "Aktivera ifall användare borde manuellt repetera repetervapen genom att trycka på deras omladdningsknapp."

L["v2.settings.server.gameplay.never_ready.title"] = "Stäng av \"Readying\"-Animationer"
L["v2.settings.server.gameplay.never_ready.desc"] = "Aktivera för att avaktivera \"readying\"-animationer när du först tar fram ett vapen."

L["v2.settings.server.gameplay.recoilshake.title"] = "Aktivera Rekyl Synvält Skakning"
L["v2.settings.server.gameplay.recoilshake.desc"] = "Knäpper synfältet under skytte."

L["v2.settings.server.gameplay.equipment_generate_ammo.title"] = "Skapa Unik Ammo till Utrustning"
L["v2.settings.server.gameplay.equipment_generate_ammo.desc"] = "Source-motorn har en begränsning på 255 ammo-typer. Stäng av detta alternativ så kan det hjälpa fixa problem ifall du har många tillägg installerade.\n\nKräver omstart."

L["v2.settings.server.gameplay.mult_defaultammo.title"] = "Standard Reservammo"
L["v2.settings.server.gameplay.mult_defaultammo.desc"] = "Hur många reservmagasin eller delar utrustning spelaren får när ett vapen spawnas."

////////// Customization
L["v2.settings.server.custmenu.atts_nocustomize.title"] = "Stäng av Anpassning"
L["v2.settings.server.custmenu.atts_nocustomize.desc"] = "Stänger av förmågan för användare att öppna anpassningsmenyn.\n\nGäller ej för administratörer."

L["v2.settings.server.custmenu.atts_max.title"] = "Max Antal Tillbehör"
L["v2.settings.server.custmenu.atts_max.desc"] = "Maximalt antal tillbehör en användare kan utrusta på ett vapen, inklusive kosmetiska."

L["v2.settings.server.custmenu.free_atts.title"] = "Gratis Tillbehör"
L["v2.settings.server.custmenu.free_atts.desc"] = "Tillbehör kan användas utan att behöva först plocka upp dem."

L["v2.settings.server.custmenu.atts_lock.title"] = "Oänsliga Tillbehörsenheter"
L["v2.settings.server.custmenu.atts_lock.desc"] = "Om avstängt så kan användare som har ett tillbehör utrustat på ett vapen inte utrusta den på ett annat vapen om dem inte har fler än en av det tillbehöret."

L["v2.settings.server.custmenu.atts_loseondie.title"] = "Förlora Tillbehör vid Död"
L["v2.settings.server.custmenu.atts_loseondie.desc"] = "Om användaren dör så förlorar dem alla deras tillbehör."

L["v2.settings.server.custmenu.atts_generateentities.title"] = "Skapa Tillbehörsenheter"
L["v2.settings.server.custmenu.atts_generateentities.desc"] = "Skapa enheter som kan spawnas via Spawnmenyn, vilket tillåter dig att plocka upp tillbehör när \"Gratis Tillbehör\" är avstängt.\n\nÖkar laddningstiden."

////////// Bullet Physics
L["v2.settings.tabname.bulletphysics"] = "Skottfysik"

L["v2.settings.server.bulletphysics.bullet_physics.title"] = "Aktivera Fysiska Skott"
L["v2.settings.server.bulletphysics.bullet_physics.desc"] = "Vapen som stödjer detta skjuter fysiska projektiler som påverkas av avsläpp, motstånd och skottavstånd."

L["v2.settings.server.bulletphysics.bullet_gravity.title"] = "Skottgravitation"
L["v2.settings.server.bulletphysics.bullet_gravity.desc"] = "Hur mycket fysiska skott påverkas av gravitation."

L["v2.settings.server.bulletphysics.bullet_drag.title"] = "Skottmotstånd"
L["v2.settings.server.bulletphysics.bullet_drag.desc"] = "Hur mycket luftmotstånd fysiska skott borde ha."

L["v2.settings.server.bulletphysics.bullet_lifetime.title"] = "Skottlivstid"
L["v2.settings.server.bulletphysics.bullet_lifetime.desc"] = "Hur länge, i sekunder, det tar för att fysiska skott tas bort från existens."

L["v2.settings.server.bulletphysics.ricochet.title"] = "Aktivera Skottrikoschetter"
L["v2.settings.server.bulletphysics.ricochet.desc"] = "Tillåter skott att studsa på hårda ytor vilket kan möjligtvis träffa omisstänksamma motståndare.\n\nEffektivitet beror på vapnet."

L["v2.settings.server.bulletphysics.mod_penetration.title"] = "Aktivera Skottpenetration"
L["v2.settings.server.bulletphysics.mod_penetration.desc"] = "Tillåter skott att gå igenom skydd vilket kan möjligtvis träffa omisstänksamma motståndare som gömmer sig bakom.\n\nEffektivitet beror på vapnet."

////////// NPC Settings
L["v2.settings.tabname.npc"] = "NPC-Inställningar"

L["v2.settings.server.npc.npc_autoreplace.title"] = "Ersätt NPC-Vapen"
L["v2.settings.server.npc.npc_autoreplace.desc"] = "NPC:er som spawnar med HL2-vapen får dem ersatta med ARC9-vapen."

L["v2.settings.server.npc.npc_atts.title"] = "Ge NPC-Vapen Slumpmässiga Tillbehör"
L["v2.settings.server.npc.npc_atts.desc"] = "NPC:er med ARC9-vapen får slumpmässigt utvalda tillbehör."

L["v2.settings.server.npc.replace_spawned.title"] = "Ersätt Markvapen"
L["v2.settings.server.npc.replace_spawned.desc"] = "Ersätter kartans eller spawnade HL2-vapen med slumpmässiga ARC9-vapen."

L["v2.settings.server.npc.ground_atts.title"] = "Ge Markvapen Slumpmässiga Tillbehör"
L["v2.settings.server.npc.ground_atts.desc"] = "Vapen som spawnas på marken får slumpmässigt utvalda tillbehör."

L["v2.settings.server.npc.npc_give_weapons.title"] = "Tillåt NPC-Vapen Utbytelse"
L["v2.settings.server.npc.npc_give_weapons.desc"] = "Tillåter användare att trycka på deras USE-knapp på NPC:er för att ge eller byta ut deras ARC9-vapen."

L["v2.settings.server.npc.npc_equality.title"] = "Aktivera NPC Skadajämlighet"
L["v2.settings.server.npc.npc_equality.desc"] = "NPC:er gör lika mycket skada med ARC9-vapen som spelare gör."

L["v2.settings.server.npc.npc_spread.title"] = "NPC-Spridning"
L["v2.settings.server.npc.npc_spread.desc"] = "Multiplicera vapen träffsäkerheten när NPC:er skjuter dem."

////////// Quick Stat Modifiers
L["v2.settings.tabname.quickstat"] = "Snabb Statistik Modifiering"

L["v2.settings.server.quickstat.mod_damage.title"] = "Skada"
L["v2.settings.server.quickstat.mod_spread.title"] = "Spridning"
L["v2.settings.server.quickstat.mod_recoil.title"] = "Rekyl"
L["v2.settings.server.quickstat.mod_visualrecoil.title"] = "Visuell Rekyl"
L["v2.settings.server.quickstat.mod_adstime.title"] = "Siktetid"
L["v2.settings.server.quickstat.mod_sprinttime.title"] = "Spring-till-Siktetid"
L["v2.settings.server.quickstat.mod_damagerand.title"] = "Skadevariering"
L["v2.settings.server.quickstat.mod_muzzlevelocity.title"] = "Mynningshastighet"
L["v2.settings.server.quickstat.mod_rpm.title"] = "Eldhastighet"
L["v2.settings.server.quickstat.mod_headshotdamage.title"] = "Huvudskott Skada"
L["v2.settings.server.quickstat.mod_malfunction.title"] = "Chans för Eldavbrott"

L["v2.settings.server.quickstat.mod_damage.desc"] = "Multiplicerar hur mycket skada vapen gör."
L["v2.settings.server.quickstat.mod_spread.desc"] = "Multiplicerar hur mycket spridning vapen har."
L["v2.settings.server.quickstat.mod_recoil.desc"] = "Multiplicerar hur mycket rekyl vapen har."
L["v2.settings.server.quickstat.mod_visualrecoil.desc"] = "Multiplicerar hur mycket visuell rekyl vapen har."
L["v2.settings.server.quickstat.mod_adstime.desc"] = "Multiplicerar hur snabbt vapen går in och ur siktet."
L["v2.settings.server.quickstat.mod_sprinttime.desc"] = "Multiplicerar hur snabbt vapen går in i och slutar springa."
L["v2.settings.server.quickstat.mod_damagerand.desc"] = "Multiplicerar skadevariering, vilket lägger till eller tar bort slumpmässig skada."
L["v2.settings.server.quickstat.mod_muzzlevelocity.desc"] = "Multiplicerar hur snabbt fysiska skott flyger."
L["v2.settings.server.quickstat.mod_rpm.desc"] = "Multiplicerar hur snabbt vapnet skjuter"
L["v2.settings.server.quickstat.mod_headshotdamage.desc"] = "Multiplicerar hur mycket skada vapnet gör i huvudet."
L["v2.settings.server.quickstat.mod_malfunction.desc"] = "Multiplicerar hur stor chans det är att vapnet får eldavbrott."

////////////////////// Developer
L["v2.settings.tabname.developer"] = "Tillverkare"

////////// Developer Settings
L["v2.settings.tabname.developer.settings"] = "Tillverkare Inställningar"
L["v2.settings.tabname.developer.settings.desc"] = "Generella inställningar till tillverkare."

L["v2.settings.server.developer.reloadlangs.title"] = "Ladda om Språk"
L["v2.settings.server.developer.reloadlangs.desc"] = "Laddar om alla språkfiler till ARC9."

L["v2.settings.server.developer.reloadatts.title"] = "Ladda om Tillbehör"
L["v2.settings.server.developer.reloadatts.desc"] = "Laddar om alla ARC9-tillbehör."

L["v2.settings.server.developer.dev_always_ready.title"] = "Alltid \"Ready\""
L["v2.settings.server.developer.dev_always_ready.desc"] = "Om påslagen så kommer vapen alltid spela deras \"ready\"-animation."

L["v2.settings.server.developer.dev_benchgun.title"] = "\"Benchgun\""
L["v2.settings.server.developer.dev_benchgun.desc"] = "Om påslagen så kommer vymodellen hålla sig kvar, oberoende på vart du ställer dig."

L["v2.settings.server.developer.dev_crosshair.title"] = "Tillverkare Hårkors"
L["v2.settings.server.developer.dev_crosshair.desc"] = "Ett roligt liten hårkors som visar exakt siktepunkt och lite användbara nummer.\n\nFungerar endast för administratörer; försök inte fuska med detta."

L["v2.settings.server.developer.dev_show_affectors.title"] = "Visa \"Affectors\""
L["v2.settings.server.developer.dev_show_affectors.desc"] = "På \"Tillverkare Hårkorset\" så visas nuvarande aktiva \"affectors\" som tillämpas."

L["v2.settings.server.developer.dev_show_shield.title"] = "Visa Sköld"
L["v2.settings.server.developer.dev_show_shield.desc"] = "Visa skyddande modellen av spelarens sköld."

L["v2.settings.server.developer.dev_greenscreen.title"] = "Green Screen"
L["v2.settings.server.developer.dev_greenscreen.desc"] = "Tillämpar en \"green screen\"-bakgrund i anpassningsmenyn.\n\nAnvändbar för skärmbilder.\n\nOm du använder HDR, glöm inte att sätta \"mat_bloom_scalefactor_scalar\" till 0!"

L["v2.settings.server.developer.presets_clear.title"] = "Rensa Vapendata"
L["v2.settings.server.developer.presets_clear.desc"] = "Rensar förinställningar, ikoner och standard förinställningar på det vapen du håller i.\n\nVarning: Om det används utan ett ARC9-vapen i händerna så rensar det förinställningar, ikoner och standard förinställningar på alla ARC9-vapen."

L["v2.settings.server.developer.reload"] = "LADDA OM"
L["v2.settings.server.developer.clear"] = "RENSA"

////////// Asset Caching
L["v2.settings.tabname.assetcache"] = "Tillgång Förladdning"
L["v2.settings.tabname.assetcache.desc"] = "Förladdning av vissa tillgångar kan förhindra frysning för en mer bekväm spelupplvelse.\n\nOm du spelar på en HDD, eller med många tillägg, så kan dessa inställningar förbättra första laddningstiden."

L["v2.settings.server.assetcache.precache_sounds_onfirsttake.title"] = "När Vapen Utrustas: Förladda Ljud"
L["v2.settings.server.assetcache.precache_sounds_onfirsttake.desc"] = "Förladdar alla skottljuden på det ARC9-vapnet du tar fram.\n\nKan göra att spelet fryser sig en kort stund när du utrustar vapen för första gången."

L["v2.settings.server.assetcache.precache_attsmodels_onfirsttake.title"] = "När Vapen Utrustas: Förladda Tillbehör"
L["v2.settings.server.assetcache.precache_attsmodels_onfirsttake.desc"] = "Förladdar alla ARC9-tillbehörsmodeller när ett ARC9-vapen tas fram.\n\nKan göra att spelet fryser sig en längre tid, beroende på hur många ARC9-vapen du har."

L["v2.settings.server.assetcache.precache_wepmodels_onfirsttake.title"] = "När Vapen Utrustas: Förladda Vapenmodeller"
L["v2.settings.server.assetcache.precache_wepmodels_onfirsttake.desc"] = "Förladdar alla ARC9-vymodeller när ett ARC9-vapen tas fram.\n\nKan göra att spelet fryser sig en mycket längre tid, beroende på hur många ARC9-vapen du har."

L["v2.settings.server.assetcache.precache_allsounds_onstartup.title"] = "När Spelet Startas: Förladda Ljud"
L["v2.settings.server.assetcache.precache_allsounds_onstartup.desc"] = "Förladdar alla skottljud till alla ARC9-vapen när servern startas.\n\nKan göra att spelet temporärligt fryser."

L["v2.settings.server.assetcache.precache_attsmodels_onstartup.title"] = "När Spelet Startas: Förladda Tillbehör"
L["v2.settings.server.assetcache.precache_attsmodels_onstartup.desc"] = "Förladdar alla ARC9-tillbehörsmodeller när servern startas.\n\nKan göra att spelet fryser sig en längre tid, beroende på hur många ARC9-vapen du har."

L["v2.settings.server.assetcache.precache_wepmodels_onstartup.title"] = "När Spelet Startas: Förladda Vapenmodeller"
L["v2.settings.server.assetcache.precache_wepmodels_onstartup.desc"] = "Förladdar alla ARC9-vymodeller när servern startas.\n\nKan göra att spelet fryser sig en mycket längre tid, beroende på hur många ARC9-vapen du har."

L["v2.settings.server.assetcache.precache_allsounds.title"] = "Förladda Alla Ljud"
L["v2.settings.server.assetcache.precache_allsounds.desc"] = "Förladdar alla skottljud till alla ARC9-vapen.\n\nKan göra att spelet temporärligt fryser."

L["v2.settings.server.assetcache.precache_attsmodels.title"] = "Förladda Alla Tillbehörsmodeller"
L["v2.settings.server.assetcache.precache_attsmodels.desc"] = "Förladdar alla ARC9-tillbehörsmodeller.\n\nKan göra att spelet fryser sig en längre tid, beroende på hur många ARC9-vapen du har."

L["v2.settings.server.assetcache.precache_wepmodels.title"] = "Förladda Alla Vapenmodeller"
L["v2.settings.server.assetcache.precache_wepmodels.desc"] = "Förladdar alla ARC9-vymodeller.\n\nKan göra att spelet fryser sig en mycket längre tid, beroende på hur många ARC9-vapen du har."

L["v2.settings.server.assetcache"] = "FÖRLADDA"
L["v2.settings.server.assetcache.all"] = "FÖRLADDA ALLA"

////////// Print to Console
L["v2.settings.tabname.printconsole"] = "Skriv till Konsolen"
L["v2.settings.tabname.printconsole.desc"] = "Tryck på \"Skriv Ut\" på dessa för att skriva ut det som begärs till din tillverkarkonsol."

L["v2.settings.server.printconsole.dev_listmyatts.title"] = "Skriv Ut Mina Tillbehör"
L["v2.settings.server.printconsole.dev_listmyatts.desc"] = "Skriver ut interna namnen på alla av vapnets utrustade tillbehör."

L["v2.settings.server.printconsole.dev_listanims.title"] = "Skriv Ut Animationlista"
L["v2.settings.server.printconsole.dev_listanims.desc"] = "Skriver ut hela interna animationslistan, inklusive deras längd."

L["v2.settings.server.printconsole.dev_listbones.title"] = "Skriv Ut Benlista"
L["v2.settings.server.printconsole.dev_listbones.desc"] = "Skriver ut hela listan av ben från vymodellens skelett."

L["v2.settings.server.printconsole.dev_listbgs.title"] = "Skriv Ut \"Bodygroups\""
L["v2.settings.server.printconsole.dev_listbgs.desc"] = "Skriver ut hela listan av vymodellens \"bodygroups\"."

L["v2.settings.server.printconsole.dev_listatts.title"] = "Skriv Ut \"QCAttachments\""
L["v2.settings.server.printconsole.dev_listatts.desc"] = "Skriver ut hela listan av vymodellens \"QCAttachments\"."

L["v2.settings.server.printconsole.dev_listmats.title"] = "Skriv Ut Materiallistan"
L["v2.settings.server.printconsole.dev_listmats.desc"] = "Skriver ut hela materiallistan som används på vymodellen."

L["v2.settings.server.printconsole.dev_export.title"] = "Skriv Ut Exportkod"
L["v2.settings.server.printconsole.dev_export.desc"] = "Skriver ut en exportkod för vapnets aktivt utrustade tillbehör.\n\nKan sparas eller delas med andra användare för att snabbt ladda en lista tillbehör."

L["v2.settings.server.printconsole.dev_getjson.title"] = "Skriv Ut Vapen-JSON"
L["v2.settings.server.printconsole.dev_getjson.desc"] = "Skriver ut JSON-kod för vapnet."

L["v2.settings.server.printconsole"] = "SKRIV UT"