...
L["autostat.secondary.blindfire"] = "盲射" -- No longer exists, you can skip this line
...
L["settings.hud_cust.language_id.title"] = "语言"
...
L["settings.hud_cust.cust_roll_unlock.title"] = "解锁武器横滚"
L["settings.hud_cust.cust_roll_unlock.desc"] = "允许武器在 Z 轴上被拖拽旋转。"
