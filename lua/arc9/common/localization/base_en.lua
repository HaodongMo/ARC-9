...
L["settings.performance.cheapscopes.title"] = "Cheap Scopes"
L["settings.performance.cheapscopes.desc"] = "A cheap RT scope implementation by zooming your whole view to aim, instead of rendering world again in a scope. Significantly increases performance on large maps."
L["settings.performance.allflash.title"] = "All Flashlights"
L["settings.performance.allflash.desc"] = "Fully render all flashlights from other players.\n\nVery expensive."
L["settings.performance.tpik.title"] = "TPIK"
L["settings.performance.tpik.desc"] = "TPIK (Third Person Inverse Kinematics) is a system that allows most weapons display detailed and same as in first person hands positions, reload and firing animations in third person.\n\nConfigure it in Visuals tab."
L["settings.performance.blur.title"] = "Blur"
L["settings.performance.cust_blur.title"] = "Customization Background"
L["settings.performance.cust_blur.desc"] = "Blurs customization background."
L["settings.performance.fx_reloadblur.title"] = "While Reloading"
L["settings.performance.fx_reloadblur.desc"] = "Blurs the world while reloading."
L["settings.performance.fx_animblur.title"] = "While readying"
L["settings.performance.fx_animblur.desc"] = "Blurs the world while deploying a weapon for the first time."
L["settings.performance.fx_rtblur.title"] = "In Scopes"
L["settings.performance.fx_rtblur.desc"] = "Blurs the world while using a magnified scope."
L["settings.performance.fx_adsblur.title"] = "In Sights"
L["settings.performance.fx_adsblur.desc"] = "Blurs the weapon while aiming down sights."
L["settings.performance.shelleject.title"] = "Shell Eject"
L["settings.performance.eject_fx.title"] = "Smoke Effects"
L["settings.performance.eject_fx.desc"] = "Produce smoke effects from ejected shell casings, where the weapon supports this feature"
L["settings.performance.eject_time.title"] = "Add Life Time"
L["settings.performance.eject_time.desc"] = "Allow shell casings to stay in the world for longer. Can be expensive."