...
L["settings.fx_rtvm.title"] = "Draw Weapon in RT Scopes"
L["settings.fx_rtvm.desc"] = "make some desc and better name pls  : 3 mega expensive i think, renders whole gun and all its attachments second time   for sure, works only with cheap scopes off    experemental"
