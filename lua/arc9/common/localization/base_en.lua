...
L["settings.gameplay.movedispersion.title"] = "Preserve ADS Spread"
L["settings.gameplay.movedispersion.desc"] = "Disable spread increasing while moving, shooting, or mid-air while ADS.\n\nThis is a server variable."
...
L["settings.visuals.vm_hipsway.title"] = "Hip Sway Multiplier"
L["settings.visuals.vm_hipsway.desc"] = "Changes amount of bobbing while in hip-fire."
L["settings.visuals.vm_adssway.title"] = "ADS Sway Multiplier"
L["settings.visuals.vm_adssway.desc"] = "Changes amount of bobbing while aiming down sights."
L["settings.visuals.vm_airsway.title"] = "Mid-air Sway Multiplier"
L["settings.visuals.vm_airsway.desc"] = "Changes amount of bobbing while airborne."
