...
L["settings.gameplay.movedispersion.title"] = "Сохранить разброс ADS"
L["settings.gameplay.movedispersion.desc"] = "Отключить увеличение разброса при движении, стрельбе или в воздухе при ADS.\n\nЭто переменная сервера."
...
L["settings.visuals.vm_hipsway.title"] = "Множитель раскачивания бедра"
L["settings.visuals.vm_hipsway.desc"] = "Изменяет величину раскачивания при стрельбе от бедра."
L["settings.visuals.vm_adssway.title"] = "Множитель раскачивания ADS"
L["settings.visuals.vm_adssway.desc"] = "Изменяет величину раскачивания при прицеливании."
L["settings.visuals.vm_airsway.title"] = "Множитель раскачивания в воздухе"
L["settings.visuals.vm_airsway.desc"] = "Изменяет величину раскачивания в воздухе."
