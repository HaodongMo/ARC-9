...
L["settings.gameplay.movedispersion.title"] = "Pwesewve ADS Spwead"
L["settings.gameplay.movedispersion.desc"] = "Disable spwead incweasing while moving, showoting, ow mid-aiw while ADS.\n\ndis is a sewvew vawiable."
...
L["settings.visuals.vm_hipsway.title"] = "Hip Sway Multipliew"
L["settings.visuals.vm_hipsway.desc"] = "Changes amount of bowobing while in hip-fiwe."
L["settings.visuals.vm_adssway.title"] = "ADS Sway Multipliew"
L["settings.visuals.vm_adssway.desc"] = "Changes amount of bowobing while aiming down sights."
L["settings.visuals.vm_airsway.title"] = "Mid-aiw Sway Multipliew"
L["settings.visuals.vm_airsway.desc"] = "Changes amount of bowobing while aiwbowne."
