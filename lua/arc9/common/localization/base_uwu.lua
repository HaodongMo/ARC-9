...
-- Language loc is actually unused so you can feel free to skip dese
L["bg"] = "Bulgarian"
L["cs"] = "Czech"
L["da"] = "Danish"
L["de"] = "German"
...
L["autostat.secondary.blindfire"] = "whiwe blind-Firing" -- No longer exists, you can skip dis line
...
-- Use dis method to localize convars in settings menu:
...
L["settings.optics.cheapscopes.desc"] = "A cheap wT scope implementation by zooming youw whole view to aim, instead of wendewing wowld again in a scope. Significantly incweases pewfowmance on lawge maps"
...
L["settings.hud_cust.language_id.desc"] = "Language pack to use fow AWC9"
...
L["settings.hud_cust.cust_roll_unlock.title"] = "Unlock woll" -- NOT USED ANYMOwE
L["settings.hud_cust.cust_roll_unlock.desc"] = "Allow weapon woll in de customization menu.\n\nMight look and contwol not de best way" -- NOT USED ANYMOwE
...
L["settings.visuals.tpik_oders.title"] = "Odew Playews TPIK"
L["settings.visuals.tpik_oders.desc"] = "Showo TPIK fow playews odew than youwself. Negatively impacts pewfowmance"
...
L["settings.controller.controller_rumble.title"] = "uwumble"
L["settings.controller.controller_rumble.desc"] = "Enable contwollew wumble as long as Fesiug's DLL mod is loaded.\n\ngithub.com/Fesiug/\ngmod-sinput"
...
L["settings.muzzle_oders.title"] = "Odew nuzzle Effects"
L["settings.muzzle_oders.desc"] = "Enable nuzzle effects fwom odew playews' guns"
