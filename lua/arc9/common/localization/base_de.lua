...
L["settings.gameplay.movedispersion.title"] = "ADS-Streuung beibehalten"
L["settings.gameplay.movedispersion.desc"] = "Streuungserhöhung während Bewegung, Schießen oder in der Luft mit ADS deaktivieren.\n\nDies ist eine Servervariable."
