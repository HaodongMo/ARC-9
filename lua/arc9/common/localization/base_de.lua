...
L["settings.npc.npc_atts.title"] = "Zubehörteile geben"
L["settings.npc.npc_atts.desc"] = "Gespawnte oder gegebene ARC9-Waffen erhalten einen zufälligen Satz Zubehörteile.\n\nDies ist eine Server-Variable."
