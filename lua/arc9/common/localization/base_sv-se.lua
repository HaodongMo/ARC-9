...
L["settings.gameplay.movedispersion.title"] = "Bevara ADS-spridning"
L["settings.gameplay.movedispersion.desc"] = "Inaktivera spridningsökning när du flyttar, fotograferar eller i luften medan ADS.\n\nDetta är en servervariabel."
...
L["settings.visuals.vm_hipsway.title"] = "Höftsvängningsmultiplikator"
L["settings.visuals.vm_hipsway.desc"] = "Ändrar mängden gupp i höfteld."
L["settings.visuals.vm_adssway.title"] = "ADS Sway Multiplikator"
L["settings.visuals.vm_adssway.desc"] = "Ändrar mängden gupp medan du siktar neråt."
L["settings.visuals.vm_airsway.title"] = "Svajmultiplikator i luften"
L["settings.visuals.vm_airsway.desc"] = "Ändrar mängden gupp i luften."
