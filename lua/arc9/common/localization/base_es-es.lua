...
L["settings.gameplay.movedispersion.title"] = "Preservar la dispersión de la mira"
L["settings.gameplay.movedispersion.desc"] = "Deshabilitar el aumento de la dispersión al moverse, disparar o estar en el aire mientras se apunta con la mira.\n\nEsta es una variable del servidor."
...
L["settings.visuals.vm_hipsway.title"] = "Multiplicador de balanceo de cadera"
L["settings.visuals.vm_hipsway.desc"] = "Cambia la cantidad de balanceo mientras se dispara desde la cadera."
L["settings.visuals.vm_adssway.title"] = "Multiplicador de balanceo de ADS"
L["settings.visuals.vm_adssway.desc"] = "Cambia la cantidad de balanceo mientras se apunta con la mira."
L["settings.visuals.vm_airsway.title"] = "Multiplicador de balanceo en el aire"
L["settings.visuals.vm_airsway.desc"] = "Cambia la cantidad de balanceo mientras se está en el aire."
