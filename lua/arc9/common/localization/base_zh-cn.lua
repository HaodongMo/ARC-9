...
L["settings.gameplay.movedispersion.title"] = "保留瞄准扩散"
L["settings.gameplay.movedispersion.desc"] = "禁止在移动、射击或空中瞄准时增加扩散。\n\n这是一个服务器变量。"
...
L["settings.visuals.vm_hipsway.title"] = "腰部摆动倍增器"
L["settings.visuals.vm_hipsway.desc"] = "改变腰射时的摆动量。"
L["settings.visuals.vm_adssway.title"] = "ADS 摆动倍增器"
L["settings.visuals.vm_adssway.desc"] = "改变瞄准时的摆动量。"
L["settings.visuals.vm_airsway.title"] = "空中摆动倍增器"
L["settings.visuals.vm_airsway.desc"] = "改变空中的摆动量。"
