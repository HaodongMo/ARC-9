...
ARC9.SettingsTable = {
    ...
    },
    {
        ...
        { sv = true, type = "bool", text = "settings.gameplay.movedispersion.title", convar = "movedispersion", desc = "settings.gameplay.movedispersion.desc" },
    ...
    },
    {
		...
		{ type = "slider", min = 0, max = 2, decimals = 1, text = "settings.visuals.vm_hipsway.title", convar = "vm_hipsway", desc = "settings.visuals.vm_hipsway.desc" },
		{ type = "slider", min = 0, max = 2, decimals = 1, text = "settings.visuals.vm_adssway.title", convar = "vm_adssway", desc = "settings.visuals.vm_adssway.desc" },
		{ type = "slider", min = 0, max = 2, decimals = 1, text = "settings.visuals.vm_airsway.title", convar = "vm_airsway", desc = "settings.visuals.vm_airsway.desc" },
