...
local settingstable = {
    ...
    -- { type = "c", text = "Color yeah" }, -- { type = "t", text = "Yrint the " },
    {
        TabName = "Tab name 2",
        {
            type = "bool",
...
local function DrawSettings(bg)
    ...
    for _, v in pairs(settingstable) do
        ...
        newpanel.Paint = function(self, w, h)
            draw.RoundedBox(0, 0, 0, w, h, ARC9.GetHUDColor("bg"))
        end
    ...
    bg.Paint = function(self2, w, h)
        ...
        surface.DrawPoly({
            ...
            {
                x = 0,
                y = h - math.max(ARC9ScreenScale(5), talll - buttontalling)
            },
            {
                x = ARC9ScreenScale(75.4),
                y = h - math.max(ARC9ScreenScale(5), talll - buttontalling)
            },
            {
                x = ARC9ScreenScale(75.4),
        ...
        surface.DrawPoly({
            {
                x = w - ARC9ScreenScale(75.4),
                y = h
            },
            {
                x = w - ARC9ScreenScale(75.4),
                y = ARC9ScreenScale(25.7)
            },
            {
                x = w,
                y = ARC9ScreenScale(25.7)
