...
do
    ...
    function SWEP:ThinkVisualRecoil()
        ...
        for i = 1, 3 do
            vpa[i] = math_Clamp(vpa[i], -500, 500)
            vpv[i] = math_Clamp(vpv[i], -500, 500)
            new_vpc[i] = math_Clamp(new_vpc[i], -500, 500)
        end
        ...
        for i = 1, 3 do
            vaa[i] = math_Clamp(vaa[i], -750, 750)
            vav[i] = math_Clamp(vav[i], -750, 750)
            new_vac[i] = math_Clamp(new_vac[i], -750, 750)
        end
