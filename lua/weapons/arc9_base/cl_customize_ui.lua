...
function SWEP:CreateCustomizeHUD()
    ...
    hintspanel.Paint = function(self2, w, h)
        ...
        for _, v in ipairs(trolling) do
            ...
            if ARC9.CTRL_Exists[v.glyph] then v.glyph = Material( "arc9/" .. ARC9.GlyphFamilyCust() .. v.glyph .. ".png", "smooth" ) end
            if v.glyph2 then
                ...
                if ARC9.CTRL_Exists[v.glyph2] then v.glyph2 = Material( "arc9/" .. ARC9.GlyphFamilyCust() .. v.glyph2 .. ".png", "smooth" ) end
            end
