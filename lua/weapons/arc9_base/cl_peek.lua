...
function SWEP:ThinkPeek()
    if arc9_togglepeek_reset:GetBool() and self:GetSightAmount() < 0.5 or self:GetBipod() or !self:GetProcessedValue("CanPeek", true) then self.Peeking = false return end
